		...
		foreach ($this->table_links as $tl) {
			...
			if (!$tl['anchor']) {
				...
				if ( $result ) {
					...
					// On parcours $tl["occ"] pour ajouter les entrŽes qui ne s'y trouvent pas
